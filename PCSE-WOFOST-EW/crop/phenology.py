...
class DVS_Phenology(SimulationObject):
    ...
    **Signals sent or handled**
    ...
    class Parameters(ParamTemplate):
        ...
        EXTREME_WEATHER_FUNCTION = Float(-99.)  # The extreme weather function F(EW) was added by Zheng et al. (2024) to simulate crop growth under extreme weather conditions.
    ...
    def calc_rates(self, day, drv):
        ...
        if s.STAGE == "emerging":
            ...
            r.DTSUME = 0.
            r.DTSUM = p.DTSMTB(
                drv.TEMP) * VERNFAC * DVRED * p.EXTREME_WEATHER_FUNCTION  # The extreme weather function operates during the vegetative period.
            r.DVR = r.DTSUM / p.TSUM1

        elif s.STAGE == 'reproductive':
            r.DTSUME = 0.
            r.DTSUM = p.DTSMTB(
                drv.TEMP) * p.EXTREME_WEATHER_FUNCTION  # The extreme weather function operates during the reproductive period.
